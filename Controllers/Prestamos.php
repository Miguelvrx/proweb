...
class Prestamos extends Controller
{
    ...
    public function ticked($id_prestamo)
    {
        ...
        $pdf->SetFont('Arial', 'B', 8);
        $pdf->Cell(15, 5, utf8_decode("Direccion: "), 0, 0, 'L');
        $pdf->SetFont('Arial', '', 8);
        ...
        $pdf->SetFillColor(0, 0, 0);
        $pdf->SetTextColor(255, 255, 255);
        $pdf->Cell(72, 5, utf8_decode ("Detalles del préstamo"), 1, 1, 'C', 1);
        $pdf->SetTextColor(0, 0, 0);
        ...
        $pdf->SetFont('Arial', '', 8);
        $pdf->Cell(35, 5, utf8_decode($prestamo['nombre']), 1, 0, 'L');
        $pdf->Cell(37, 5, $prestamo['carrera'], 1, 1, 'L');
        $pdf->Ln();
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->Cell(72, 5, utf8_decode('Fecha del préstamo'), 0, 1, 'C');
        $pdf->SetFont('Arial', '', 10);
